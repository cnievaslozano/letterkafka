@props(['user', 'userImage', 'creation_date', 'review', 'portada', 'likes'])
        ...
        <div class="flex flex-col flex-grow ml-4">
            ...
            <div class="flex mt-3">
                <a href="#"><img src="{{ $portada }}" class="border border-black min-w-32 min-h-48"
                        ...
                        <?php $combinedReviews = implode(' ', $review); ?>
                        <p class="ml-4">{{ $combinedReviews }} <a href="#">Leer más...</a></p>
                               </div>
            <div class="flex mt-2">
...
{{--@else--}}
    <div class="flex w-full py-4 border-b border-[#493736]">
        ...
        <div class="flex flex-col flex-grow ml-2">
            ...
            <?php $combinedReviews = implode(' ', $review); ?>
            <p class="mt-1 text-sm">{{ substr($combinedReviews, 0, 100) }}. <a href="#">Leer más...</a></p>
                    <div class="flex mt-2">
